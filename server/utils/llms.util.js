...
export const llms = {
    ...
    "sarvam-ai": new SarvamAI({ model: "sarvam-ai", maxOutputTokens: 8096, stream: true }),
    "sarvam-ai-thinker": new SarvamAI({ model: "sarvam-ai-thinker", maxOutputTokens: 8096, stream: true }),
}